...
wave phenomena, \new{which means that the DLF can be used to model seismic
wavefields as well,} and by providing new filters with the accompanying code.
The algorithm and many more examples of its usage can be found on
...
\plot*{error}{width=\textwidth}{Relative error plots comparing the DLF
  ...
  the order of $10^{-25}\,$V/m, and therefore far below the noise level.}
%
