...
\plot*{Figure-2}{width=\textwidth}{%
  ...
  square in subplot (b) is the starting point of Figure~\ref{fig:Figure-3}.}%
%
...
%
\plot*{Figure-4}{width=.9\textwidth}{(a) Filter values of the best obtained
...
%
\plot*{ftGPR}{width=\textwidth}{The real\old{-part} \new{and imaginary parts of
the} frequency-domain \new{(a-c)} and the time-domain \new{(d-f)} responses for
offsets of (a/d) 0.2\,m, (b/e) 2.0\,m, and (c/f) 3.0\,m.}
%
