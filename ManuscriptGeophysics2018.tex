...
HERE figures for validity

That line is where the quasistatic approximation breaks down,  where sigma =
omega epsilon rather than being much greater.

So the filters work well for diffusion, right up to the limit where the quasi
static approximation breaks down. That’s a good observation to put in the
paper.
